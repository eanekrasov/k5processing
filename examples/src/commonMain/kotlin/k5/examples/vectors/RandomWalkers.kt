 ...
 * left, right, up, down
 */
fun K5.simpleRandomWalk() {

    var x = 400f
    var y = 400f
    val points = mutableListOf(Offset(x, y))

    show(modifier = Modifier.fillMaxSize().background(Color.Black)) {
...
fun K5.levyFlightWalker() {
    ...
    show {
        ...
        /* If you want to make walker jump randomly, you can just use any random scalar to multiply with step vector above^*/
