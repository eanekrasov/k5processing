...
fun K5.showPietMondrian() {
    ...
    fun flushAndAdd() {
        squares.clear()
        squares.add(Square(0f, 0f, size.width, size.height))
    }
    flushAndAdd()
    ...
    fun generateSquares() {
        var step = size.width.toInt() / stepDivider
        for (i in 0 until size.width.toInt() step step.toInt()) {
